...
namespace Placeworkers.Forms
{
    ...
    {
        public static string GetEmbeddedResourcePath(Assembly assembly, string resourceFileName)
        {
        ...
        public static Stream GetEmbeddedResourceStream(Assembly assembly, string resourceFileName) => assembly.GetManifestResourceStream(GetEmbeddedResourcePath(assembly, resourceFileName));
